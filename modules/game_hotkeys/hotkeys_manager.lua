...
local function triggerDarkDungeonsPotionCooldown(itemId)
    ...
    if modules.game_actionbar and modules.game_actionbar.onMultiUseCooldown then
        modules.game_actionbar.onMultiUseCooldown(DD_POTION_COOLDOWN_MS)
    end
end
HotkeyActions = {{
...
function executeHotkeyItem(action, itemId, subType)
    triggerDarkDungeonsPotionCooldown(itemId)
