...
SpellInfo = {
    Default = {
        ...
        ['DD Hoja Toxica'] = { id = 202, name = 'DD Hoja Toxica', words = 'dd toxica', type = 'Instant', level = 30, mana = 25, soul = 0, maglevel = 0, icon = '', clientId = 57, group = { [1] = 1000 }, needTarget = true, parameter = false, range = 1, exhaustion = 12000, premium = false, vocations = {8}, special = false, source = 0 },
        ...
        ['DD Disparo Certero'] = { id = 213, name = 'DD Disparo Certero', words = 'dd disparo', type = 'Instant', level = 30, mana = 20, soul = 0, maglevel = 0, icon = '', clientId = 58, group = { [1] = 1000 }, needTarget = true, parameter = false, range = 7, exhaustion = 5000, premium = false, vocations = {7}, special = false, source = 0 },
        ...
        ['DD Marca del Cazador'] = { id = 214, name = 'DD Marca del Cazador', words = 'dd cazador', type = 'Instant', level = 30, mana = 30, soul = 0, maglevel = 0, icon = '', clientId = 109, group = { [1] = 1000 }, needTarget = true, parameter = false, range = 7, exhaustion = 20000, premium = false, vocations = {7}, special = false, source = 0 },
        ...
        ['DD Castigo Sagrado'] = { id = 221, name = 'DD Castigo Sagrado', words = 'dd castigo', type = 'Instant', level = 30, mana = 25, soul = 0, maglevel = 0, icon = '', clientId = 52, group = { [1] = 1000 }, needTarget = true, parameter = false, range = 5, exhaustion = 5000, premium = false, vocations = {6}, special = false, source = 0 },
        ['DD Rezo Curativo'] = { id = 222, name = 'DD Rezo Curativo', words = 'dd rezo', type = 'Instant', level = 30, mana = 45, soul = 0, maglevel = 0, icon = '', clientId = 5, group = { [2] = 1000 }, needTarget = true, parameter = true, range = -1, exhaustion = 16000, premium = false, vocations = {6}, special = false, source = 0 },
